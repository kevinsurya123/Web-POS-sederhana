                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <button class="btn btn-dark" data-bs-target="#modalCust" data-bs-toggle="modal">Cari Supplier</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <div class="d-grid gap-3 d-md-flex justify-content-md-end">
                                ...
                                <button onclick="bayar()" class="btn btn-success me-med-2" type="button">Proses Bayar</button>
...
<?= $this->include('pembelian/modal-customer') ?>
<script>
    function load() {
