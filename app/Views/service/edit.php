...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <!-- Form Tambah Buku -->
                <form action="<?= base_url('service/edit/' . $result['service_id']) ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                        ...
                        <div class="col-sm-3">
                            <select type="text" class="form-control" id="service_category_id" name="service_category_id">
                                <?php foreach ($category as $value) : ?>
                                    <option value="<?= $value['service_category_id'] ?>" <?= $value['service_category_id'] == $result['service_category_id'] ? 'selected' : '' ?>>
