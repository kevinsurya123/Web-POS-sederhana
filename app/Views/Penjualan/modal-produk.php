                    ...
                    <tbody>
                        ...
                        foreach ($dataService as $value) : ?>
                            <tr>
                                ...
                                <td><?= $value['stock'] ?></td>
                                <td>
                                    <button onclick="add_cart('<?= $value['service_id'] ?>',
                                    '<?= $value['title'] ?>','<?= $value['price'] ?> ',' <?= $value['discount'] ?>')" class="btn btn-success">
    ...
    function add_cart(id, name, price, discount) {
        $.ajax({
            ...
            success: function(data) {
                load()
                // $('#detail_cart').load('Penjualan::loadCart')
